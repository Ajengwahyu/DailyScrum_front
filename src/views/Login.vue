            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h6 class="font-weight-light">
                  Login untuk mengakses aplikasi daily scrum.
                </h6>
                <form class="pt-3" method="post" action="#" v-on:submit.prevent="Login">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input v-model="email" type="email" class="form-control form-control-lg border-left-0" id="email" name="email" placeholder="E-Mail" require />
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
  ...
  methods: {
    Login: function() {
      ...
      this.$store
        ...
        .then(() => this.$router.push("/my_daily_scrum"))
